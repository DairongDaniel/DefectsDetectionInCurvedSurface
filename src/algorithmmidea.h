...
struct ParamForTemplate {
    ...
    std::vector<cv::Rect> backgroundRoiRectVec;
    int trainRectExtendFringe;
};

struct FeatureOfTemplate {
    std::vector<cv::Rect> trainSubImageRectVec;
    std::vector<cv::Rect> undetectAreaVec;
    std::vector<cv::Rect> backgroundAreaVec;
...
public:
    ...
    ******************************************/
     ...
     * correct: otherwise
    ******************************************/
    static int detectBlackDot(const cv::Mat &srcImage,cv::Mat &dstImage,ParamForBlackDot &paramSets,FeatureOfTemplate &templateParamSets,cv::Mat &mask);
    ...
    ******************************************************************************/
    ...
    static void removeBasePlane( const cv::Mat &srcImage, cv::Mat &dstImage,FeatureOfTemplate &featureTemplate);
    ...
    ******************************************************************************/
    ...
    bool inspectLineofPen(const cv::Mat &srcImage1, const cv::Mat &srcImage2, const cv::Mat &srcImage3, const cv::Mat &srcImage4, cv::Mat &dstImage);
